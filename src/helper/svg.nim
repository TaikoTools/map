...
const svgTekkan* = """<svg width="100%" height="100%">
...
const svgDora* = """ <svg width="100%" height="100%">
  <circle cx="50%" cy="50%" r="40%" stroke="black" stroke-width="1" fill="#c0c0c0" />
  <circle cx="50%" cy="50%" r="15%" fill="black" />
  <rect x="0" y="0" stroke="black" stroke-width="0" fill="#c0c0c0" width="5%" height="100%"></rect>
  <rect x="95%" y="0" stroke="black" stroke-width="0" fill="#c0c0c0" width="5%" height="100%"></rect>
  <rect x="0%" y="0" stroke="black" stroke-width="0" fill="#c0c0c0" width="100%" height="5%"></rect>
Sorry, your browser does not support inline SVG.
</svg>"""
